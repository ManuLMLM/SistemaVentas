...
public partial class SistemaVentasContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C4FA0E109");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F2DE782FD");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483AC8CBEFA");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107CA7C843A");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E834FB0BD");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132546ABE08");
            ...
            entity.HasOne(d => d.IdCategoriaNavigation).WithMany(p => p.Productos)
                ...
                .HasConstraintName("FK__Producto__idCate__37A5467C");
        });

        modelBuilder.Entity<Rol>(entity =>
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F768AFE4B8F");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8C7771922");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEDC648A2E");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6EFF115F7");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561469F511DE");
            ...
            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__idTipoDoc__403A8C7D");
